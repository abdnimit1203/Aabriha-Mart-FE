...
export function StatCard({
  ...
  const content = (
    <div className="rounded-md border border-border bg-surface p-5 transition-colors hover:border-primary/40">
      <div
...
export function StatCardSkeleton() {
  return (
    <div className="rounded-md border border-border bg-surface p-5">
      <div className="mb-3 h-9 w-9 animate-pulse rounded bg-background" />
